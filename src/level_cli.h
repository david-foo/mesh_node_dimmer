...
extern void gen_move_set(struct bt_mesh_model *model,  s32_t delta_level, u32_t delay, s32_t trans_time);
extern void gen_move_set_unack(struct bt_mesh_model *model,  s32_t delta_level, u32_t delay, s32_t trans_time);
